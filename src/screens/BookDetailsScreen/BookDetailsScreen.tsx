    ...
    <>
      {isLoading ? (
        ...
        <Styled.DetailsContainer>
          ...
          <BookDescription
            title={bookData?.title || t('screen.details.title')}
            author={bookData?.author || t('screen.details.author')}
